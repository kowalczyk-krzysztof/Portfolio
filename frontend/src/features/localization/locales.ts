...
export const locale_JP: Locale = {
  ...
  aboutDescription: `Krzysztofです｡ フルスタック開発者｡ 何故ソフトウェア開発しますか？ お役に立てる高品質のソフトウェアをお客様に届けることが私の目指しです｡ オンラインで多くの時間を過ごします｡ ですからインターネットユーザーの欲しい物をよく分かります｡ 効率とユーザーエクスペリエンスのバランスを見つけるのは本当に難しいことです｡ でも私はそれをできると信じています｡ 問題があるなら絶対に解決します｡`,
